  ...
  while (tree != NULL) {
    ...
    { switch (tree->kind.exp) {
        ...
        case IdK:
          ...
          break;
        case ArrIdK:
          fprintf(listing,"ArrId, name : %s, with index below \n",tree->attr.name);
          break;
        case NumK:
        ...
        case VarK:
          ...
          break;
        case VarArrayK:
          fprintf(listing,"VarArray, name : %s, type : %s, with size below\n",tree->attr.name, tree->type == Integer ? "int" : "void");
          break;
        case FuncK:
          fprintf(listing,"Function declaraction, name: %s, return type : %s\n",tree->attr.name,  tree->type == Integer ? "int" : "void");
          break;
        case SingleParamK:
